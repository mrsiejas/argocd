...
# Clone Repository
Clone mrsiejas/argocd repository to your local device.
```
git clone https://github.com/mrsiejas/argocd.git
```
...
server:
  ...
  config:
    repositories: |
      - type: git
        url: https://github.com/mrsiejas/argocd.git
      - name: argo-helm
        type: helm
  ...
  additionalApplications: 
    - name: argocd
      ...
      source:
        ...
        repoURL: https://github.com/mrsiejas/argocd.git
        targetRevision: HEAD
      syncPolicy:
        syncOptions:
